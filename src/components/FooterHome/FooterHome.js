...
export default function FooterHome() {
  return (
    <div className="row p-4 m-0 mt-5" style={{ backgroundColor: "#ffc6c7" }}>
      <div className="col-4">
        <div className="mb-3">
          <img src="./images/MIN-OP1.png" style={{ height: "100px" }} />
          <p>
        ...
        <div className="mb-3">
          ...
          <div className="d-flex">
            ...
            />
            <button className="btn btn-warning ml-2 default-button">
              ĐĂNG KÍ
            </button>
          </div>
        </div>
      ...
      <div className="col-4">
        ...
        <p>
          ...
          trình tư duy Lập trình Java Web Lập trình Java Spring - Java Boot Tôi
          Đi Code Dạo Học SEO Hà Nội ở Vietmoz Học lập trình trực tuyến
        </p>
      </div>
      <div className="col-4">
        <iframe
